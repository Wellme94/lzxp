...
var shopxx = {
	base: "http://www.lppz.com",
	login: "https://login.lppz.com",
	locale: "zh_CN"
};
...
(function($) {
	...
	$.redirectLogin = function(redirectUrl, message) {
		var href = shopxx.login;
		if(redirectUrl != null) {
			href += "?service=" + encodeURIComponent(redirectUrl);
		}
		if(message != null) {
...
function login() {
	return location.href = "https://login.lppz.com?service=" + escape(location.href).replace(/\//g, "%2F"), !1
}
//BAIDU
var _hmt = _hmt || [];
(function() {
	var hm = document.createElement("script");
	hm.src = "//hm.baidu.com/hm.js?7cefb8e3a7c5228e2810c2d7556c4653";
