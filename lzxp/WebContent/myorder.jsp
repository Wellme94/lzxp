	...
	<!--顶部快捷菜单-->
		...
		<!--<div class="yHeader">
			<div class="shop_Nav">
				...
				<ul class="Menu_box">
					<li>
						<a href="" target="_blank" class="yMenua">首页</a>
					</li>
					<li>
						<a href="" target="_blank">大划算</a>
					</li>
					<li>
						<a href="" target="_blank">抢拍</a>
					</li>
					<li>
						<a href="" target="_blank">锡货专场</a>
					</li>
					<li>
						<a href="" target="_blank">锡货超市</a>
					</li>
				</ul>
							...
							<div class="xm-box">
								...
								<div class="box-bd">
									<div class="clearfix xm-address-list" id="checkoutAddrList">
										<dl class="item">
											<dt>
                <strong class="itemConsignee">威猛先生</strong>
                                <span class="itemTag tag">公司</span>
                            </dt>
											<dd>
												<p class="tel itemTel">15961726437</p>
												<p class="itemRegion">福建 厦门市 思明区</p>
												<p class="itemStreet">软件园二期观日路2号</p>
										...
										<div class="item use-new-addr" id="J_useNewAddr" data-state="off">
											<span class="iconfont icon-add"><img src="images/order/add_cart.png" /></span> 使用新地址
										</div>
									</div>
						...
						<div class="checkout-box-ft">
                                ...
                                <span class="col col-4">小计（元）</span>
											...
											<dd class="item clearfix">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
															<img src="img/jianguo/013.jpg" srcset="" width="40" height="40" />
														</div>
														<div class="g-info">
															<a href="#">
																伊朗开心果190g </a>
											...
											<dd class="item clearfix">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
															<img src="img/jianguo/011.jpg" srcset="" width="40" height="40" />
														</div>
														<div class="g-info">
															<a href="#">
																黑美人葵花籽(奶油味) </a>
											...
											<dd class="item clearfix">
												<div class="item-row">
													<div class="col col-1">
														<div class="g-pic">
															<img src="img/jianguo/021.jpg" srcset=" " width="40" height="40" />
														</div>
														<div class="g-info">
															<a href="#">
																杰克牌牛奶味方形威化饼干100g</a>
							...
							<div class="checkout-confirm">
								...
								<a href="commit.html" class="btn btn-primary" >立即付款</a>
							</div>
						</div>
				</div>
